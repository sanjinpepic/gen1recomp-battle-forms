...
-- ---------------------------------------------------------------------
-- The party list's own icon no longer lives in this module at all -- see
-- src/formicons.lua's own header for why (a shared pokemon.icon hook
-- subscription now answers for both games) -- and its own coverage lives in
-- tests/battle_forms_formicons_test.lua, driving the real, hook-augmented
-- PartyMenu classes on both sides rather than a function this file no
-- longer exports.
-- ---------------------------------------------------------------------
