...
return function(mod)
  ...
  -- battle in sight.
  -- registry/state back exports.gimmicks and exports.arm: a peer drawing its
  -- own battle scene needs the cell's three facts and a way to arm, and gets
  -- them as copies and a toggle rather than as these two objects. They are
  -- bound rather than published for that reason -- see src/formapi.lua's own
  -- note on what handing the registry over would hand over with it.
